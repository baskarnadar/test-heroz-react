...
const ParentModifyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/admindata/schoolmgm/parentinfo/list'), 1500);
    } catch (error) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="divhbg">
        <div className="txtheadertitle">{ProductID ? '' : ''}Modify Parent </div>
...
export default ParentModifyForm;
