...
const Vendor = () => {
  ...
  return (
    <div>
      ...
      <div className="divhbg">
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <button
            ...
            onClick={() => navigate('/vendordata/activityinfo/membership/list?')}
          >
            {tr('btnReturn', 'Return')}
          </button>
        </div>
          ...
          <div className="divbox">
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1, textAlign: 'right' }}>{tr('summaryAmount', 'Amount Exc VAT')}</div>
                <div style={{ flex: 1, textAlign: 'right' }}>
                  {tr('summaryVat', 'VAT')} <span style={vatPillStyle}>({vatPercentValue}%)</span>
                </div>
                <div style={{ flex: 1, textAlign: 'right' }}>{tr('summaryTotal', 'Total Inc Vat')}</div>
              </div>
              ...
              <div style={{ padding: '8px 12px' }}>
                ...
                >
                  ...
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 600 }}>{to2(tripPriceBase)}</div>
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 600 }}>{to2(tripVatAmount)}</div>
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 700 }}>{to2(tripTotalWithVat)}</div>
                </div>
                ...
                >
                  ...
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 600 }}>{to2(foodBaseAmount)}</div>
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 600 }}>{to2(foodVatAmount)}</div>
                  <div style={{ flex: 1, textAlign: 'right', fontWeight: 700 }}>{to2(foodTotalWithVat)}</div>
                </div>
                ...
                <div style={{ display: 'flex', padding: '8px 0 4px', fontWeight: 700, alignItems: 'center' }}>
                  ...
                  <div style={{ flex: 1, textAlign: 'right' }}>{to2(totalBaseAmount)}</div>
                  <div style={{ flex: 1, textAlign: 'right' }}>{to2(totalVatAmount)}</div>
                  <div style={{ flex: 1, textAlign: 'right' }}>{to2(totalWithVat)}</div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div style={{ fontWeight: 800, fontSize: 24, color: '#1b5e20', marginTop: 8 }}>
                {to2(totalWithVat)}
              </div>
            </div>
          </div>
      ...
      {/* ✅ NEW: Trip Details + What's Included (DISPLAY ONLY) */}
      <div className="txtsubtitle">{tr('sectionTripDetails', 'Trip Details')}</div>
      <div className="divbox">
        <div className="vendor-container">
          <div className="form-group">
            <label style={{ marginBottom: 10, marginTop: 10 }}>
              {tr('labelTripDetail', 'Trip Detail')}
            </label>
          ...
          <div className="form-group">
            <label style={{ marginBottom: 10, marginTop: 10 }}>
              {tr('labelWhatsIncluded', "What's Included")}
            </label>
