// (keep same path as your project) e.g. src/pages/membership/activityinfo/activity/ActivityList.jsx
...
import {
  ...
  dspstatus,
  getAuthHeaders,
  IsMemberShipLoginIsValid,   // ✅ IsMemberShipLoginIsValid imported here
...
const ActivityList = () => {
  // ✅ membership login guard: runs once when component mounts
  useEffect(() => {
  ...
  const handleModifyClick = (ActivityID) => {
    navigate(`/membership/activityinfo/activity/modify?ActivityID=${ActivityID}`)
  }

  const handleViewClick = (ActivityID) => {
    navigate(`/membership/activityinfo/activity/view?ActivityID=${ActivityID}`)
  }
  ...
  return (
    <div>
      <div className="page-title">
        ...
        <button
          onClick={() => navigate('/membership/activityinfo/activity/new')}
