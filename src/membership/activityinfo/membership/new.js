...
import { DspToastMessage, getAuthHeaders, IsMemberShipLoginIsValid } from '../../../utils/operation'
  ...
  return (
    <div>
      ...
      <div className="txtsubtitle">
        ...
        <span className="act-uploadNote">at least 3 images are required. at least 3 images are required. upload min image with (500px and png or jpg</span>
      </div>
