// (keep same path as your project) e.g. src/pages/membership/activityinfo/membership/ActivityList.jsx
...
const ActivityList = () => {
  ...
  const handleModifyClick = (ActivityID) => {
    navigate(`/membership/activityinfo/membership/modify?ActivityID=${ActivityID}`)
  }

  const handleViewClick = (ActivityID) => {
    navigate(`/membership/activityinfo/membership/view?ActivityID=${ActivityID}`)
  }
  ...
  return (
    <div>
      <div className="page-title">
        ...
        <button
          onClick={() => navigate('/membership/activityinfo/membership/new')}
