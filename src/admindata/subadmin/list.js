            ...
            <tbody>
              {users.map((user, index) => (
                <tr key={user.prtuserid}>
                  <td><strong>{(currentPage - 1) * usersPerPage + index + 1}</strong></td>
                  ...
                  <td>
                    <CIcon onClick={() => handleModifyClick(user.prtuserid)} icon={cilPencil} size="lg" className="edit-icon" />
                    <CIcon onClick={() => handleDeleteClick(user.prtuserid)} icon={cilTrash} size="lg" className="trash-icon" />
                  </td>
                </tr>
              ))}
            </tbody>
