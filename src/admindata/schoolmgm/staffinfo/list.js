...
const StudentList = () => {
  ...
  const handleModify = (id) => navigate(`/admindata/schoolmgm/staffinfo/modify?SchoolID=${id}`);
  const handleView = (id) => navigate(`/admindata/schoolmgm/staffinfo/view?SchoolID=${id}`);
  const handleNew = () => navigate('/admindata/schoolmgm/staffinfo/new');
