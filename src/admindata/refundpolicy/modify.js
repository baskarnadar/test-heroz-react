...
const AGREEMENT_API = `${API_BASE_URL}/commondata/operation/updaterefundpolicy`; // Update endpoint
const GET_AGREEMENT_API = `${API_BASE_URL}/commondata/operation/getrefundpolicy`; // Prefill endpoint
