      ...
      >
        <div className="form-group text-center">
          <div style={{ padding: "20px" }}>
            ...
            <b>TRIP STAUS STATUS : </b>{" "}
            {dspstatusv1(TripData?.actRequestStatus)}{" "}
          </div>
        </div>
      </div>
      ...
      <div className="divbox">
        ...
        <div className="vendor-container">
          <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
            ...
            >
              <div className="admin-lbl-box pink-badge">
                {" "}
                {ActivityData?.actGender}{" "}
              </div>
            </label>
          </div>
        </div>
        ...
        {ActivityData?.priceList?.map((priceItem, index) => {
          ...
          return (
            <CRow className="align-items-center mb-2" key={index}>
              ...
              <CCol sm={2}>
                <div className="admin-lbl-box pink-shadow6">
                  {priceItem.Price}
                </div>
              </CCol>
              <CCol sm={2}>
      ...
      <div className="divbox">
        <div style={{ margin: "20px auto", fontFamily: "Arial, sans-serif" }}>
          {[
            ...
            .filter((day) =>
              ActivityData?.availList?.some((item) => item.DayName === day)
            )
            .map((day) => {
